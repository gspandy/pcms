 ...
 * 保险续保任务按照经销商进行任务分单
 * **/
@Service("InsuranceContinueTaskAssignee")
public class InsuranceContinueTaskAssignee implements ITaskAssigneeHandle {
	...
	public String handle(String assigneeParam, TaskEntity taskEntity) {
		...
		ProcessTaskUserBo assignee = this.getProcessTaskAccount(sysBranch.getId() ,assigneeParam, null);
	...
	private ProcessTaskUserBo getProcessTaskAccount(String dealerId,String workgroupId,List<String> candidateAccounts) {
		// TODO Auto-generated method stub
		...
		List<HashMap> listMatch = workgroupService.getTaskMathcRuleByDealerId(dealerId, listGroup, candidateAccounts);
		if(listMatch.size()==0)
		{
			return null;
		}
