...
/**
 * 催收任务按照产品编码、经销商、逾期天数进行任务分单
 * **/
@Service("CollectionTaskAssignee")
public class CollectionTaskAssignee implements ITaskAssigneeHandle {
	...
	public String handle(String assigneeParam, TaskEntity taskEntity) {
		...
		ProcessTaskUserBo assignee = this.getProcessTaskAccount(apply.getProductCode(),sysBranch.getId(), ledgerPo.getAddupOverdueDay() ,assigneeParam, null);
