...
public class HelloOss {
	...
	private static String endpoint = "oss-cn-hzfinance.aliyuncs.com";

	// accessKeyId和accessKeySecret是OSS的访问密钥，您可以在控制台上创建和查看，
	// 创建和查看访问密钥的链接地址是：https://ak-console.aliyun.com/#/。
	// 注意：accessKeyId和accessKeySecret前后都没有空格，从控制台复制时请检查并去除多余的空格。
	private static String accessKeyId = "A9aOBT2jgwLlIkPc";
	private static String accessKeySecret = "AsO82796GQoeayzQxurziFwckw7JL9";

	// Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
	// Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
	private static String bucketName = "pcms-test";
	...
	public static void main(String[] args) {
		...
		try {
			...
			ossClient.putObject(bucketName, "dir/"+"1231/"+firstKey, is);
			System.out.println("Object：" + "dir/"+"1231/"+firstKey + "存入OSS成功。");
			...
			inputStream.close();
			System.out.println("Object：" + "dir/"+"1231/"+firstKey + "的内容是：" + objectContent);
